...
public final class TextField implements UIComponent {
    ...
    public UIComponent build(Layout layout, Theme theme) {
        return new WidgetFactoryWrapper(() -> new TextFieldWidget(this, message, hintText, validator, formatter));
    }
    ...
    private static final class TextFieldWidget extends net.minecraft.client.gui.components.EditBox {
        ...
        public TextFieldWidget(TextField owner, Component message, Component hintText, Predicate<String> validator, BiFunction<String, Integer, FormattedCharSequence> formatter) {
            ...
            setHighlightPos(owner.highlightPos);
            setFocused(owner.focused);
            setResponder(newText -> {
                owner.text = newText;
                owner.cursorPos = getCursorPosition();
                owner.highlightPos = getCursorPosition();
                if (owner.onChange != null) {
                    owner.onChange.accept(newText);
                }
            });
        }
